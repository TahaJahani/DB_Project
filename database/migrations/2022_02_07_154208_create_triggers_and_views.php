...
class CreateTriggersAndViews extends Migration
{
  ...
  public function up()
  {
    DB::statement("CREATE VIEW in_progress_orders AS SELECT * FROM   orders WHERE  status = 'pending'");
    //------------------------------------
    DB::statement("CREATE VIEW shipping_orders AS SELECT * FROM   orders WHERE  status = 'shipping'");
    //------------------------------------
    DB::statement("CREATE VIEW pending_comments AS SELECT * FROM   comments WHERE  status = 'pending'");
    //------------------------------------
